...
broker = "broker.hivemq.com" #broker: servidor que atua como intermediário 
topico = "simulador/mqtt/mensagem" #tópico: Categoria para troca de mensagens 
mensagens = []
lock = Lock() #objeto de sicronização
