...
INSERT INTO tbl_livro(nome_livro, data_publicacao, preco_livro)
VALUES
	('Grandes Sertão: Veredas', '1956-01-01', 39.90),
...
SELECT nome_livro AS 'Nome do livro', 
	DATE_FORMAT(data_publicacao, '%d/%m/%y') AS 'Data de Publicacao'
FROM tbl_livro;
...
SELECT *
FROM tbl_livro WHERE preco_livro >20 ORDER BY peco_livro ASC LIMIT 3;
