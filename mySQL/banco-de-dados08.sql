...
/*INNER JOIN: pegar a interseção entre as tabelas: as coisas em 
comum. Exemplo: retornar somente os empregados com departamento 
associado*/
...
FROM tabela1
INNER JOIN tabela 2 ON tabela1.id = tabela2.id*/

/*LEFT JOIN
Lista todos os clientes e seus pedidos, mostrando NULL para cliente que não 
tenham pedidos*/
...
/*RIGHT JOIN
lista todos os pedidos e os clientes correspondentes, incluindo 
pedidos com cliente ausente*/
SELECT pedidos.pedido_id, pedidos.valor, clientes.cliente_id, clientes.nome 
AS cliente
FROM clientes
RIGHT JOIN pedidos ON clientes.cliente_id = pedidos.cliente_id;

/* FULL JOIN
Listar todos os empregados e depantamentos*/ 
